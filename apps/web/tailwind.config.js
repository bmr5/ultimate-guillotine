...
module.exports = {
  darkMode: ["class"],
  // The Vite app keeps everything under src, plus the one HTML entry. The Next-shaped
  // ./pages, ./components and ./app globs this scaffold shipped with match nothing here.
