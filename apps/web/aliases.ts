 ...
 * own Vite, and loading the app's Vite config through it is the one thing that can go wrong —
 ...
 *
 * @param rootDir the app directory. Each config passes its own `import.meta.dirname`, so the
 *   paths resolve against the config's location rather than the process working directory.
 */
