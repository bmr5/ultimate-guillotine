...
`guillotine-eod-summary` at `15 8 * * 0,1,3,5` and `guillotine-eod-summary-thursday` at
`15 11 * * 4`, Mac mini local time (8:15 AM Wednesday, Friday, Sunday and Monday; 11:15 AM
Thursday -- Ben's cadence), both agent `eod-summary`, one status line to `#guillotine-ops`, gap
budget 3000 minutes. The league sees it as the Guillotine Daily. Off-season and post-final weeks are a
