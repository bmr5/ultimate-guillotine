...
Run 2026-09-09 14:20 UTC against the fake client (harness self-check).
...
**58 run · 58 passed · 0 failed · 14 skipped (prerequisite state).**
...
| 55 | not_a_trade | `not_a_trade` | `not_a_trade` | `not_a_trade` | `not_a_trade` | pass | — |
