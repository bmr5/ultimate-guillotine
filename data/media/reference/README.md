...
| `source/espn-schefter-clean-1024.mp4` | The generation reference: 12 s of the ESPN footage from 2.5 s in, cropped to the square above the lower third and upscaled to 1024, no audio. Nothing written in frame, so Seedance has no text to copy. | cut from the ESPN upload with ffmpeg (`crop=520:520:380:0`) |
